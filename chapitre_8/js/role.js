...
Joueur.decrire = function () {
    var description = this.nom + " a " + this.sante + " points de vie, " +
        this.force + " en force, " + this.xp + " points d'expérience, " + this.po + " pièces d'or et " + this.cle + " clé(s)";
    return description;
};
...
Joueur.combattre = function (adversaire) {
    ...
    if (adversaire.sante === 0) {
        console.log(this.nom + " a tué " + adversaire.nom + " et gagne " +
            adversaire.valeur + " points d'expérience ainsi que " + adversaire.po + " pièces d'or et " + adversaire.cle + " clé(s)");
